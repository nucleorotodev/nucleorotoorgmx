<section id="single-post" class="columns small-12 large-9 h-a p-0 p-md-1 p-top color-blanco">
  ...
  if (have_posts()):
    ...
    <div class="columns small-12 medium-5 p-0-2 p-md-1 h-30-v h-md-60-v">
    ...
    <div class="columns small-12 p-1 h-a">
      ...
      <div class="columns small-12 medium-4 p-0 text-center">
        <small>
          Escrito: <?php echo get_the_author(); ?>
        </small>
      </div>
      <!--  -->
