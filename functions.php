...
function dependencias() {
  ...
  wp_enqueue_style( 'app-styles', get_template_directory_uri() . '/public/css/app.css');
  ...
  wp_enqueue_script( 'slick-carousel', get_template_directory_uri() .'/node_modules/slick-carousel/slick/slick.js', array('jquery') );
  ...
  wp_enqueue_script( 'app-js', get_template_directory_uri() . '/public/js/app.js', array('jquery') );
