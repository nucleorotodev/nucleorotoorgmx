...
function dependencias() {
  ...
  wp_enqueue_style( 'app-styles', get_template_directory_uri() . '/public/css/app.min.css');
  ...
  wp_enqueue_script( 'slick-carousel', get_template_directory_uri() .'/bower_components/slick-carousel/slick/slick.min.js', array('jquery') );
  ...
  wp_enqueue_script( 'app-js', get_template_directory_uri() . '/public/js/app.min.js', array('jquery') );
